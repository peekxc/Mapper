...
m <- mapper(X = noisy_circle, filter_values = f_x, 
            cover_params = list(typename="fixed interval", number_intervals=5L, percent_overlap=50),
            measure = "euclidean", 
            cluster_params = list(cl="single"))
print(m)
```
...
all_params <- list(
  ...
  cluster_params = list(cl="single", cutoff_method="histogram", num_bins=10L)
)
