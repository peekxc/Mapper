...
```{r}
MapperRef$new(noisy_circle)$
  set_cover({
    FixedRectangularCover$new(filter_values = f_x)$
      set_parameter(number_intervals = 5L, percent_overlap = 0.35)$
      construct_cover()
  })
  set_clustering_algorithm(cl = "single", num_bins = 10)$
