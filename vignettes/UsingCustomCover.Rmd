...
__private`$`__
- `.level_sets` := list of data indices that intersect the open sets
- `.index_set` := character vector of keys that uniquely index the level sets
- `.filter_dim` := constant representing the filter dimension
- `.filter_size` := constant representing the number of points in the filter space
- `.typename` := string identifier of the covering method
